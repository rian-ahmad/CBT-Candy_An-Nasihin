...
($id_siswa == 0) ?  header("Location:$homeurl/anasihin/login.php") : null;
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link rel='shortcut icon' href='<?= $homeurl ?>/anasihin/favicon.ico' />
    <link rel='stylesheet' href='<?= $homeurl ?>/anasihin/dist/bootstrap/css/bootstrap.min.css' />
    <link rel='stylesheet' href='<?= $homeurl ?>/anasihin/plugins/fontawesome/css/all.css' />
    <link rel='stylesheet' href='<?= $homeurl ?>/anasihin/dist/css/AdminLTE.min.css' />
    <link rel='stylesheet' href='<?= $homeurl ?>/anasihin/dist/css/skins/skin-green-light.min.css' />
    <link rel='stylesheet' href='<?= $homeurl ?>/anasihin/plugins/iCheck/square/green.css' />
    <link rel='stylesheet' href='<?= $homeurl ?>/anasihin/plugins/animate/animate.min.css'>
    <link rel='stylesheet' href='<?= $homeurl ?>/anasihin/plugins/sweetalert2/dist/sweetalert2.min.css'>
    <!-- <link rel='stylesheet' href='<?= $homeurl ?>/plugins/slidemenu/jquery-slide-menu.css'> -->
    <link rel='stylesheet' href='<?= $homeurl ?>/anasihin/plugins/toastr/toastr.min.css'>
    <link rel='stylesheet' href='<?= $homeurl ?>/anasihin/plugins/radio/css/style.css'>
    <script src='<?= $homeurl ?>/anasihin/plugins/jQuery/jquery-2.2.3.min.js'></script>
    <script src='<?= $homeurl ?>/anasihin/plugins/tinymce/tinymce.min.js'></script>

    <style>
        @font-face {
            font-family: 'tulisan_keren';
            src: url('<?= $homeurl ?>/anasihin/dist/fonts/poppins/Poppins-Light.ttf');
        }
        body {
            font-family: 'tulisan_keren';
            font-size: 12px;
...
<body class='hold-transition skin-green-light  fixed <?= $sidebar ?>'>
        ...
        <header class='main-header'>
            <a href='javascript:window.location.reload(true)' class='logo' style='background-color:#f9fafc'>
                <span class='animated flipInX logo-mini'>
                    <img src="<?= $homeurl . "/anasihin/" . $setting['logo'] ?>" height="30px">
                </span>
                <span class='animated flipInX logo-lg' style="margin:-3px;color:#000">
                    <img src="<?= $homeurl . '/anasihin/' . $setting['logo'] ?>" height="40px"> <?= $setting['sekolah'] ?>
                </span>
            </a>
                        ...
                        <li class='dropdown user user-menu'>
                            <a href='#' class='dropdown-toggle' data-toggle='dropdown'>
                                ...
                                if ($siswa['foto'] <> '') :
                                    if (!file_exists("foto/fotosiswa/$siswa[foto]")) :
                                        echo "<img src='$homeurl/anasihin/dist/img/avatar_default.png' class='user-image'   alt='+'>";
                                    else :
                                        echo "<img src='$homeurl/anasihin/foto/fotosiswa/$siswa[foto]' class='user-image'   alt='+'>";
                                    endif;
                                else :
                                    echo "<img src='$homeurl/anasihin/dist/img/avatar_default.png' class='user-image'   alt='+'>";
                                endif;
                            ...
                            <ul class='dropdown-menu'>
                                <li class='user-header bg-red'>
                                    ...
                                    if ($siswa['foto'] <> '') :
                                        if (!file_exists("foto/fotosiswa/$siswa[foto]")) :
                                            echo "<img src='$homeurl/anasihin/dist/img/avatar_default.png' class='img-circle' alt='User Image'>";
                                        else :
                                            echo "<img src='$homeurl/anasihin/foto/fotosiswa/$siswa[foto]' class='img-circle' alt='User Image'>";
                                        endif;
                                    else :
                                        echo "<img src='$homeurl/anasihin/dist/img/avatar_default.png' class='img-circle' alt='User Image'>";
                                    endif;
                                ...
                                <li class='user-footer'>
                                    <div class='pull-right'>
                                        <a href='<?= $homeurl ?>/anasihin/logout.php' class='btn btn-sm btn-default btn-flat'><i class='fa fa-sign-out'></i> Keluar</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
            ...
            <section class='sidebar'>
                ...
                <div class='user-panel'>
                    <div class='pull-left image'>
                        ...
                        if ($siswa['foto'] <> '') :
                            if (!file_exists("foto/fotosiswa/$siswa[foto]")) :
                                echo "<img src='$homeurl/anasihin/dist/img/avatar_default.png' class='img'  style='max-width:60px' alt='+'>";
                            else :
                                echo "<img src='$homeurl/anasihin/foto/fotosiswa/$siswa[foto]' class='img'  style='max-width:60px' alt='+'>";
                            endif;
                        else :
                            echo "<img src='$homeurl/anasihin/dist/img/avatar_default.png' class='img'  style='max-width:60px' alt='+'>";
                        endif;
                ...
                <ul class='sidebar-menu tree' data-widget='tree'>
                    ...
                    <li><a href='<?= $homeurl ?>/anasihin/'><i class='fas fa-tachometer-alt fa-fw  '></i> <span> Dashboard</span></a></li>
                    <li><a href='<?= $homeurl ?>/anasihin/jadwal'><i class='fas fa-calendar fa-fw  '></i> <span> Jadwal Ujian</span></a></li>
                    <li><a href='<?= $homeurl ?>/anasihin/materi'><i class='fas fa-file fa-fw  '></i> <span> Materi Belajar</span></a></li>
                    <li><a href='<?= $homeurl ?>/anasihin/tugassiswa'><i class='fas fa-edit fa-fw  '></i> <span> Tugas Siswa</span></a></li>
                    
                    <li><a href='<?= $homeurl ?>/anasihin/hasil'><i class='fas fa-tags fa-fw '></i> <span> Hasil Ujian</span></a></li>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php while ($nilai = mysqli_fetch_array($nilaix)) : ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="<?= $homeurl . '/anasihin/lihathasil/' . enkripsi($nilai['id_ujian']) ?>"><button class='btn btn-sm btn-success'><i class='fa fa-search'></i> Lihat Hasil</button></a>
                                                                </td>
                                                            </tr>
                                                        <?php endwhile; ?>
                                                    </tbody>
                                ...
                                <div class='box box-solid' style="box-shadow: 0 1px 15px 5px rgba(0, 0, 0, 0.25);">
                                    ...
                                    <div id='loadsoal' >
                                         <div id='loading-image'>
                                            <center>
                                                <img src="<?=$homeurl ?>/anasihin/anasihin/dist/img/loader.gif" class="img-fluid" width="150">
    ...
    <script src='<?= $homeurl ?>/anasihin/plugins/zoom-master/jquery.zoom.js'></script>
    <script src='<?= $homeurl ?>/anasihin/dist/bootstrap/js/bootstrap.min.js'></script>
    <script src='<?= $homeurl ?>/anasihin/plugins/slimScroll/jquery.slimscroll.min.js'></script>
    <script src='<?= $homeurl ?>/anasihin/plugins/iCheck/icheck.min.js'></script>
    <script src='<?= $homeurl ?>/anasihin/dist/js/app.min.js'></script>
    <script src='<?= $homeurl ?>/anasihin/plugins/sweetalert2/dist/sweetalert2.min.js'></script>
    <!-- <script src='<?= $homeurl ?>/plugins/slidemenu/jquery-slide-menu.js'></script> -->
    <script src='<?= $homeurl ?>/anasihin/plugins/mousetrap/mousetrap.min.js'></script>
    <script src='<?= $homeurl ?>/anasihin/plugins/MathJax-2.7.3/MathJax.js?config=TeX-AMS_HTML-full'></script>
    <script src='<?= $homeurl ?>/anasihin/plugins/toastr/toastr.min.js'></script>
    <script>
        $('.loader').fadeOut('slow');
        ...
        <script>
            ...
            $(document).ready(function() {
                $("#modalnosoal").on('shown.bs.modal', function() {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: homeurl + '/anasihin/nosoal.php',
                        data: {
                            id_mapel: idmapel,
                            id_siswa: idsiswa,
                            pengacak: pengacak,
            ...
            $(document).ready(function() {
                ...
                function selesai() {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: homeurl + '/anasihin/selesai.php',
                        data: {
                ...
                $(document).on('click', '.done-btn', function() {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: homeurl + '/anasihin/cekselesai.php',
                        data: {
                            id_mapel: idmapel,
                            id_siswa: idsiswa,
                            id_ujian: <?= $ac ?>
