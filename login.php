...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="animated fadeIn wrap-login100" style="padding: 1vh 5vw; margin-top: 1vh">
				<form id="formlogin" action="ceklogin.php" class="login100-form validate-form">
					<span class="login100-form-title p-b-26 ">
						<img src="<?php echo $setting['logo']; ?>" style="width: 15vw" class="img-responsive" alt="Responsive image">
